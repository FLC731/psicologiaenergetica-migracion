...
const sharedStyle=document.createElement('link');sharedStyle.rel='stylesheet';sharedStyle.href=new URL('encabezado-compartido.css?v=frase-20260918',root).href;document.head.append(sharedStyle);
if(!home){
