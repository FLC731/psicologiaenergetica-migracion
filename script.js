...
const sharedStyle=document.createElement('link');sharedStyle.rel='stylesheet';sharedStyle.href=new URL('encabezado-compartido.css?v=ec01eadd',root).href;document.head.append(sharedStyle);
if(!home){
  ...
  const intro=document.createElement('p');intro.append('Soy Félix Larriba Catalán, psicólogo y psicoterapeuta.',document.createElement('br'),'Acompaño procesos de cambio profundo para superar traumas, regular emociones y encontrar sentido, con un enfoque integrador');
...
}else{document.querySelector('.hero')?.classList.add('site-hero');document.querySelector('.header')?.classList.add('site-navigation');const visual=document.createElement('script');visual.src=new URL('portada-referencia.js',root).href;document.body.append(visual);}
