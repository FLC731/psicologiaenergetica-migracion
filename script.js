// Navegación de la copia independiente; las rutas parten de la raíz del proyecto.
...
if(document.body.classList.contains('home')){
 // Orden estructural real: presentación (header visual), DESPUÉS menú, DESPUÉS contenido.
 // Se extrae la presentación de <main> y se inserta ANTES del menú original,
 // conservando el menú como hermano del encabezado, no dentro del contenido.
 const hero=document.querySelector('main > .hero');
 const header=document.querySelector('body > .header');
 if(hero&&header){header.before(hero);const brand=header.querySelector('.brand');if(brand)hero.prepend(brand);}
 ...
 const help=document.querySelector('.home-help');const main=document.querySelector('main');
 if(help&&main)main.prepend(help);
